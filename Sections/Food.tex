...
%Cutting out just beef, lamb and dairy products from our diets would lead to annual carbon savings of order the current total emissions from food~\cite{Schmidinger}, see \fref{fig:food_impact}.
%The cumulative carbon opportunity for a global switch to plant-based diets by 2050 could sequester up to 550 Gt\CdOe\ from land-use changes alone~\cite{Hayek2021}.  This is equivalent to our entire remaining GHG budget to remain within 1.5\degree C of warming, or 16 years of emissions from fossil fuels at their current rate.
...
\end{itemize}
% Encourage and incentivise the consumption of more plant-based products, inform clientele of the environmental impact of their food choices, and minimise food-related waste.
% \begin{itemize}
%             \item Increase variety and quality of plant-based food options.
%             \item Clearly label available food items with environmental impact.
%             \item Optimise food service layout to highlight food options with lower environmental impact.
%             \item Subsidise environmentally sustainable food choices.
%             \item Provide multiple portion sizes to minimise food waste; donate unused food.
%             \item Prioritise industrial composting of compostable waste and take-away containers.
%         \end{itemize}
% \end{itemize}
}
\end{reco2}
...
\begin{casestudy}[CERN Restaurant 1\label{case:CERNR1}]{CERN Restaurant 1}%
    ...
    %, reproduced from Our World in Data, with data sourced from Ref.~\cite{PooreNemecek2018}.
...
\begin{bestpractice}[Plant-Based (Vegan) Catering at Conferences and Workshops\footnote{We thank Hannah Wakeling (for WIP 2019) and Stefan Fredenhagen (for YRISW 2019) for sharing their experience as part of the respective organisational teams.}\label{catering_bp}]{Plant-Based (Vegan) Catering at Conferences and Workshops}%
